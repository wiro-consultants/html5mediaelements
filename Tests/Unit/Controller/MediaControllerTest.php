...
/**
 * Test case for class WIRO\Html5mediaelements\Controller\MediaController.
 *
...
class MediaControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * @var \WIRO\Html5mediaelements\Controller\MediaController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('WIRO\\Html5mediaelements\\Controller\\MediaController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function showActionAssignsTheGivenMediaToView() {
		$media = new \WIRO\Html5mediaelements\Domain\Model\Media();
